<div class="w-full bg-gray-100 p-6">
    <div class="w-full flex flex-col md:flex-row gap-6">
        <div class="w-full md:w-3/5 flex flex-col gap-4 bg-white rounded-2xl shadow-lg p-6">
            <div class="text-[#000000] text-xl font-bold">Datos de la Compra</div>
            <form class="flex flex-col gap-4">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="text-sm text-black">N° Compra:</label>
                        <input type="text" wire:model="ncompra" readonly class="w-full rounded-xl bg-gray-100 p-2 focus:outline-none border border-gray-300 text-black placeholder-black">
                    </div>
                </div>

                <div class="grid grid-cols-2 gap-4 items-end">
                    <div>
                        <label class="text-sm text-black">Proveedor:</label>
                        <select wire:model="proveedor_id" class="w-full rounded-xl bg-gray-100 p-2 focus:outline-none border border-gray-300 text-black">
...
@click="@this.agregarProductoDesdeFrontend(producto_id, cantidad, precio)"
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 ">
                ...
                <div class="flex justify-end mt-4">
                    <button wire:click="guardarCompra" class="bg-green-600 text-white px-4 py-2 rounded-xl hover:bg-green-800 text-sm">Finalizar Compra</button>
                </div>
            </div>
