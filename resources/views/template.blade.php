...
<head>
    ...
    <meta name="description" content="Pulpería Hilda Matus">
    <meta name="author" content="ThreePlayers">

    <title>Pulpería Hilda Matus - Dashboard</title>

    <!-- Custom fonts for this template-->
    <link href="vendor 2\fontawesome-free\css\all.min.css" rel="stylesheet" type="text/css">
    <link
...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="forgot-password.html">Olvidé mi contraseña</a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Pulpería Hilda Matus 2025</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <!-- Page level plugins -->
    <script src="vendor 2\chart.js\Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="public\js\js\demo\chart-area-demo.js"></script>
    <script src="public\js\js\demo\chart-pie-demo.js"></script>
